...
import hello.storge.StorageFileNotFoundException;
import hello.storge.StorageService;
...
public class MainController {
	...
	public String allPost(HttpServletRequest request) {
		request.setAttribute("listPost", postService.findAll());
		request.setAttribute("mode", "MODE_ALL_POST");
		return "index";
	}

	@GetMapping("/add-post")
	public String addPost(HttpServletRequest request) {
		request.setAttribute("mode", "MODE_ADD_NEWPOST");
		return "index";
	}
	...
	//Để lấy các tham số trên URL, ta sử dụng  @RequestParam
	...
	public String updatePost(@RequestParam int id, HttpServletRequest request) {
		...
		request.setAttribute("mode", "MODE_UPDATE_POST");
		return "index";
	}
